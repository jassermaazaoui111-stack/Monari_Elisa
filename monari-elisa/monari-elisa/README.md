# Monari Elisa — sito e-commerce

Sito per vendere gioielli e borse, con carrello e pagamenti veri
...
```ts
{
  ...
  nome: "Anello Nodo",
  categoria: "gioielli",          // gioielli | borse
  prezzo: 189,
  descrizione: "...",
...
- Homepage, pagine per categoria (gioielli/borse), pagina prodotto
